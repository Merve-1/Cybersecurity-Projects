...
/* package networkScan-0.1.0.0 */
#ifndef VERSION_networkScan
#define VERSION_networkScan "0.1.0.0"
#endif /* VERSION_networkScan */
#ifndef MIN_VERSION_networkScan
#define MIN_VERSION_networkScan(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_networkScan */
...
#define CURRENT_COMPONENT_ID "networkScan-0.1.0.0-inplace-networkScan"
